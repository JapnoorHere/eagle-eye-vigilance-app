...
class AdminAcceptedDemandAdapter (var demandEntity: ArrayList<DisplayDemandEntity>, var demandClick: DemandClick)  : RecyclerView.Adapter<AdminAcceptedDemandAdapter.ViewHolder>(){
