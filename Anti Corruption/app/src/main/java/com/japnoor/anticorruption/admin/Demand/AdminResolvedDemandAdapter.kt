...
class AdminResolvedDemandAdapter (var demandEntity: ArrayList<DisplayDemandEntity>, var demandClick: DemandClick)  : RecyclerView.Adapter<AdminResolvedDemandAdapter.ViewHolder>(){
