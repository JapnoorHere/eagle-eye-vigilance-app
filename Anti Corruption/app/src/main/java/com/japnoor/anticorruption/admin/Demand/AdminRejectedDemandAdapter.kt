...
class AdminRejectedDemandAdapter (var demandEntity: ArrayList<DisplayDemandEntity>, var demandClick: DemandClick)  : RecyclerView.Adapter<AdminRejectedDemandAdapter.ViewHolder>(){
