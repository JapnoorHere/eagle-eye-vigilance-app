...
import com.japnoor.anticorruption.admin.*
import com.japnoor.anticorruption.databinding.DemandDialogBinding
import com.japnoor.anticorruption.databinding.FragmentAdminAcceptedDemandBinding
import java.io.File
...
class AdminAcceptedDemand : Fragment(),DemandClick{
    ...
    lateinit var adapter: AdminAcceptedDemandAdapter
    ...
    override fun onCreateView(
        ...
        var binding = FragmentAdminAcceptedDemandBinding.inflate(layoutInflater,container,false)
        signUpEntity = SignUpEntity()
        adapter = AdminAcceptedDemandAdapter(arrayList, this)
    ...
    fun getAccDemand() {
        ...
        class Get : AsyncTask<Void, Void, Void>() {
            override fun doInBackground(vararg p0: Void?): Void? {
                arrayList.addAll(Datbase.getDatabase(requireContext()).dao().getAccDisplayDemand())
                return null
            }
