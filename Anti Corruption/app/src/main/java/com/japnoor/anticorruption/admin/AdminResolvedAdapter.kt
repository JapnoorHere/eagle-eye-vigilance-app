...
class AdminResolvedAdapter (var complaintsEntity: ArrayList<DisplayComplaintsEntity>, var complaintClickedInterface: ComplaintClickedInterface)  : RecyclerView.Adapter<AdminResolvedAdapter.ViewHolder>(){
