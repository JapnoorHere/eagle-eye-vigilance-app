...
import com.japnoor.anticorruption.admin.AdminResolvedDemandAdapter
...
class AdminresolvedDemand : Fragment() ,DemandClick{
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    var arrayList: ArrayList<DisplayDemandEntity> = ArrayList()
    lateinit var adapter: AdminResolvedDemandAdapter
    ...
    override fun onCreateView(
        ...
        adapter = AdminResolvedDemandAdapter(arrayList, this)
    ...
    fun getResDemand() {
        ...
        class Get : AsyncTask<Void, Void, Void>() {
            override fun doInBackground(vararg p0: Void?): Void? {
                arrayList.addAll(Datbase.getDatabase(requireContext()).dao().getResDisplayDemand())
                return null
            }
